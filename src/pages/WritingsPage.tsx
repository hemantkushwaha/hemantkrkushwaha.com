...
export function WritingsPage() {
  ...
  return (
    <div className="space-y-10 sm:space-y-14 pb-16">
      ...
      <Container size="xl">
        <section aria-labelledby="writings-categories-heading" className="space-y-8">
          ...
          <div className="rounded-xl border border-stone-200 bg-white p-6 sm:p-8 space-y-3 shadow-2xs">
            ...
            <p className="text-sm text-stone-600 leading-relaxed">
              This literary wing hosts original creative writing across multiple genres, including metric and free-verse poetry, serialized fiction, short narratives, reflective prose, and complete book publications. Materials will be made accessible through dedicated reading interfaces in subsequent phases.
            </p>
          </div>
          ...
          <div className="rounded-xl border border-stone-200/80 bg-stone-100/50 p-6 flex items-start gap-4">
            ...
            <div className="space-y-1">
              <h3 className="text-sm font-medium text-stone-900">
                Literary Works in Editorial Preparation
              </h3>
              <p className="text-xs sm:text-sm text-stone-600 leading-relaxed">
                Poetry anthologies, novel manuscripts, and story collections are undergoing editorial preparation before public reading releases. No synthetic stories or placeholder poems are published.
              </p>
            </div>
          </div>
        </section>
